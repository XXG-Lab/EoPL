...
(define program-div-by-zero "print
try /(5, 0)
catch(x) 56")
(test program-div-by-zero 56)

(define program-throw "print
throw 12 to letcc x in x")
(test program-throw 12)

(define program-throws "print
throw 12 to letcc x in throw x to letcc y in y")
(test program-throws 12)
