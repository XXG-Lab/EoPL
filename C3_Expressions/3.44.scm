      ...
      (diff-exp (exp1 exp2)
                (let ((val1 (value-of exp1 nameless-env))
                  ...
                  (let ((num1 (expval->num val1))
                    ...
                    (num-val
                     (- num1 num2)))))
      (known-diff-exp (exp1 exp2 rand)
                      (let ((extended-env (extend-nameless-env (value-of rand nameless-env)
                                                               nameless-env)))
                        (let ((val1 (value-of exp1 extended-env))
                              (val2 (value-of exp2 extended-env)))
                          (let ((num1 (expval->num val1))
                                (num2 (expval->num val2)))
                            (num-val
                             (- num1 num2))))))
