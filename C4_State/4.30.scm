...
(test program-6 '(5 4 3 2 1 0))

(define program-7 "{ print let glo = pair(11, 22)
                           in let f = proc(loc)
...
(define program-8 "{ print let a = newarray(2,-99)
                               p = proc (x)
                                       let v = arrayref(x,1)
                                       in arrayset(x,1,-(v,-1))
                           in begin
...
(define program-9 "{ print let a = newarray(2,-99)
                               p = proc (x)
                                       let v = arrayref(x,1)
                                       in arrayset(x,1,-(v, minus(arraylength(x))))
                           in begin
                                  arrayset(a,1,0);
                                  (p a);
                                  (p a);
